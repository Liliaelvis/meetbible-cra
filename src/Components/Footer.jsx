...
function Footer() {
    return ( 
        <footer className="footer px-10 py-4 border-t text-base-content border-base-300 bg-gray-950">
            <aside className="items-center grid-flow-col">
                ...
                <p>Meet Bible<br/><a href="mailto:lili@meetbible.faith">Lili Martínez</a></p>
            </aside> 
